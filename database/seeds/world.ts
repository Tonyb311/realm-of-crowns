...
const TOWNS: TownDef[] = [
  ...
  },
  {
    ...
    availableBuildings: ['TANNERY', 'FLETCHER_BENCH', 'MARKET_STALL', 'INN', 'HOUSE_SMALL'],
    x: 720, y: 480,
    prosperityLevel: 2,
  ...
  // ========================================
  {
    ...
    availableBuildings: ['TANNERY', 'FLETCHER_BENCH', 'MARKET_STALL', 'INN', 'STABLE', 'HOUSE_SMALL', 'HOUSE_MEDIUM'],
    x: 450, y: 380,
    prosperityLevel: 3,
