...
const ITEM_TEMPLATES: ItemTemplateDef[] = [
  ...
  },
  {
    ...
    type: 'MATERIAL',
    rarity: 'COMMON',
    description: 'A faintly luminous mote of energy left behind by a will-o-wisp. Flickers between visibility and invisibility.',
    stats: {},
    durability: 100,
    professionRequired: null,
    levelRequired: 1,
  ...
  },
  {
    ...
    type: 'MATERIAL',
    rarity: 'COMMON',
    description: 'Fine glowing powder harvested from destroyed spectral entities. Cold to the touch and faintly luminescent.',
    stats: {},
    durability: 100,
    professionRequired: null,
    levelRequired: 1,
  ...
  },
  {
    ...
    type: 'MATERIAL',
    rarity: 'FINE',
    description: 'A living flower plucked from a dryad grove. Its petals shimmer with natural magic and never wilt.',
    stats: {},
    durability: 100,
    professionRequired: null,
    levelRequired: 1,
  ...
  // --- Gemstones (mining resource) ---
  {
    ...
    type: 'MATERIAL',
    rarity: 'FINE',
    description: 'Uncut precious stones extracted from deep rock. Sought by jewelers for rings and enchanted accessories.',
    stats: {},
    durability: 100,
    professionRequired: null,
    levelRequired: 1,
