  ...
  if (!isOpen) {
    return (
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 bg-realm-danger-light text-realm-text-primary text-[10px] font-bold rounded-full min-w-[18px] h-[18px] flex items-center justify-center px-1">
      ...
      <div className="fixed bottom-12 md:bottom-12 right-4 z-30 w-80 bg-realm-bg-700 border border-realm-border border-b-0 rounded-t-lg shadow-xl">
        <div className="flex items-center justify-between px-3 py-2">
          ...
          >
            ...
            Chat
            {unreadCount > 0 && (
              <span className="bg-realm-danger-light text-realm-text-primary text-[10px] font-bold rounded-full min-w-[16px] h-4 flex items-center justify-center px-1">
                {unreadCount}
              </span>
            )}
          </button>
