    ...
    >
      ...
      {visible && (
        <span
          ...
          role="tooltip"
        >
          <span className="block bg-realm-bg-900 border border-realm-border text-realm-text-primary text-xs rounded-sm px-3 py-1.5 shadow-lg whitespace-nowrap max-w-xs">
            {content}
          </span>
          <span
