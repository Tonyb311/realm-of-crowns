...
const ApothecaryPage = React.lazy(() => import('./pages/ApothecaryPage'));
...
const AdminCodexPage = React.lazy(() => import('./pages/admin/AdminCodexPage'));
      ...
      <div className="min-h-screen bg-realm-bg-900">
        ...
        <Routes>
          ...
          <Route path="/admin" element={<AdminRoute><AdminLayout /></AdminRoute>}>
            ...
            <Route path="codex" element={<AdminCodexPage />} />
