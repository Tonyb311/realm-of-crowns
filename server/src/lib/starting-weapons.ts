...
import { STARTER_WEAPONS, FALLBACK_STARTER_WEAPON, StarterWeaponDef } from '@shared/data/starter-weapons';
...
export async function ensureStarterWeaponTemplates(): Promise<void> {
  ...
  logger.info({ count: Object.keys(STARTER_WEAPONS).length }, 'Starter weapon templates ensured');
}
