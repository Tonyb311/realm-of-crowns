...
export const COOK_RECIPES: RecipeDefinition[] = [
  // ── Tier 1 — Level 1 ──────────────────────────────
  {
    ...
    levelRequired: 1,
    inputs: [{ itemName: ITEMS.GRAIN, quantity: 2 }],
  ...
  },
  {
    ...
    professionRequired: 'COOK',
    levelRequired: 1,
    inputs: [{ itemName: ITEMS.APPLES, quantity: 3 }],
  ...
  },
  {
    ...
    professionRequired: 'COOK',
    levelRequired: 1,
    inputs: [{ itemName: ITEMS.RAW_FISH, quantity: 2 }],
  ...
  },
  {
    ...
    professionRequired: 'COOK',
    levelRequired: 1,
    inputs: [{ itemName: ITEMS.VEGETABLES, quantity: 3 }],
  ...
  // ── Tier 2 — Level 5 ──────────────────────────────
  {
    ...
    professionRequired: 'COOK',
    levelRequired: 5,
    inputs: [{ itemName: ITEMS.FLOUR, quantity: 2 }],
