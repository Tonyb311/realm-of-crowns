...
export const COOK_RECIPES: RecipeDefinition[] = [
  ...
  },
  {
    ...
    professionRequired: 'COOK',
    levelRequired: 1,
    inputs: [{ itemName: ITEMS.WILD_BERRIES, quantity: 3 }, { itemName: ITEMS.WOOD_LOGS, quantity: 1 }],
  ...
  },
  {
    ...
    professionRequired: 'COOK',
    levelRequired: 1,
    inputs: [{ itemName: ITEMS.RAW_FISH, quantity: 2 }, { itemName: ITEMS.WOOD_LOGS, quantity: 1 }],
    outputs: [{ itemName: ITEMS.GRILLED_FISH, quantity: 1 }],
    craftTime: 15,
    xpReward: 10,
    tier: 1,
  },
  {
    ...
    professionRequired: 'COOK',
    levelRequired: 1,
    inputs: [{ itemName: ITEMS.WILD_HERBS, quantity: 2 }, { itemName: ITEMS.WOOD_LOGS, quantity: 1 }],
  ...
  },
  {
    ...
    levelRequired: 5,
    inputs: [
      { itemName: ITEMS.FLOUR, quantity: 1 },
  ...
  },
  {
    ...
    levelRequired: 5,
    inputs: [
      { itemName: ITEMS.RAW_FISH, quantity: 2 },
      { itemName: ITEMS.WILD_HERBS, quantity: 1 },
      { itemName: ITEMS.WOOD_LOGS, quantity: 1 },
    ],
    outputs: [{ itemName: ITEMS.FISH_STEW, quantity: 1 }],
    craftTime: 25,
    xpReward: 18,
    tier: 2,
  },
