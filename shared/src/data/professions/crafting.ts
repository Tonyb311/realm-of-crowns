...
export const ALCHEMIST: ProfessionDefinition = {
  ...
  name: 'Alchemist',
  category: 'CRAFTING',
  description: 'Alchemists brew potions, elixirs, poisons, and alchemical compounds from herbs, reagents, and vials. Health potions, mana restoratives, stat buffs, and deadly toxins all emerge from their bubbling laboratories.',
  primaryStat: 'INT',
  ...
  outputProducts: ['Health Potions', 'Mana Potions', 'Stat Buff Elixirs', 'Poisons', 'Antidotes', 'Alchemical Compounds'],
  townTypeAffinity: ['swamp', 'forest', 'academic'],
  tierUnlocks: {
    APPRENTICE: ['Minor Health Potion', 'Minor Mana Potion'],
    JOURNEYMAN: ['Health Potion', 'Mana Potion', 'Basic Antidotes'],
...
export const BREWER: ProfessionDefinition = {
  ...
  name: 'Brewer',
  category: 'CRAFTING',
  description: 'Brewers craft ales, wines, meads, and spirits from grain, hops, fruit, and honey. Their drinks grant buffs, serve as valuable trade goods, and fuel the social life of every tavern in the realm.',
  primaryStat: 'WIS',
  relatedProfessions: ['FARMER', 'HERBALIST', 'INNKEEPER', 'WOODWORKER'],
  inputResources: ['Hops', 'Wheat', 'Grapes', 'Apples', 'Honey', 'Barrels'],
  outputProducts: ['Ale', 'Wine', 'Mead', 'Spirits', 'Specialty Brews'],
  townTypeAffinity: ['plains', 'hills', 'trade'],
  tierUnlocks: {
    APPRENTICE: ['Weak Ale', 'Simple Wine'],
    JOURNEYMAN: ['Standard Ale', 'Quality Wine', 'Basic Mead'],
    CRAFTSMAN: ['Fine Ale', 'Aged Wine', 'Honey Mead'],
