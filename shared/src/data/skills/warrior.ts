...
export const warriorTier0Abilities: AbilityDefinition[] = [
  ...
  // Level 5 — "Building Up"
  { id: 'war-t0-5a', name: 'Sundering Strike', description: 'A targeted blow to armor joints, cracking their defense.', class: 'warrior', specialization: 'none', tier: 0, effects: { type: 'damage_debuff', diceCount: 1, diceSides: 4, acReduction: 2, duration: 2 }, cooldown: 3, levelRequired: 5, requiresChoice: true, choiceGroup: 'warrior_tier0_level5' },
  { id: 'war-t0-5b', name: 'Second Wind', description: 'Catch your breath mid-fight, willing yourself through the pain.', class: 'warrior', specialization: 'none', tier: 0, effects: { type: 'heal', diceCount: 1, diceSides: 8, bonusHealing: 4 }, cooldown: 4, levelRequired: 5, requiresChoice: true, choiceGroup: 'warrior_tier0_level5' },
  { id: 'war-t0-5c', name: 'Hamstring', description: 'Cut low, crippling your foe\'s movement.', class: 'warrior', specialization: 'none', tier: 0, effects: { type: 'damage_status', damage: 1, statusEffect: 'slowed', statusDuration: 2 }, cooldown: 3, levelRequired: 5, requiresChoice: true, choiceGroup: 'warrior_tier0_level5' },
